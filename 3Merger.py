...
NATALITY_PROCESSED_CSV = 'Take 2/2variable-equalizer/live.csv' # Large Natality Processed CSV
FETAL_DEATH_PROCESSED_CSV = 'Take 2/2variable-equalizer/still.csv' # Fetal Death Processed CSV

# OUTPUT: The SINGLE combined file you want for analysis/training
COMBINED_OUTPUT_CSV = 'Take 2/3merged/merge.csv' # Single output file name
