...
# --- Configuration ---
FETAL_DEATH_FILE_PATH = 'Lautin/Fetal2023PS_COD.txt'
NATALITY_FILE_PATH = 'Lifandi/Nat2023PublicUS.txt'

# --- Output File Configuration ---
OUTPUT_DIR = '.'
FETAL_DEATH_CSV_FILENAME = 'fetal_deaths_2023_processed.csv'
NATALITY_CSV_FILENAME = 'natality_2023_processed.csv'
