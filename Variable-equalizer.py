...
NATALITY_INPUT_CSV = 'Litla_settid/combined_birth_data_2023_ml_ready_litla.csv'
FETAL_DEATH_INPUT_CSV = 'Stora_settid/combined_birth_data_2023_ml_ready_stora2.csv'

# Output files (new files with only common columns)
NATALITY_TRIMMED_CSV = 'Litla_settid/combined_birth_data_2023_ml_ready_litla-FINAL.csv'
FETAL_DEATH_TRIMMED_CSV = 'Stora_settid/combined_birth_data_2023_ml_ready_stora-FINAL2.csv'
