...
NATALITY_INPUT_CSV = 'Stora_settid/natality_2023_processed.csv'
FETAL_DEATH_INPUT_CSV = 'Take 2/1csv/summa.csv'

# Output files (new files with only common columns)
NATALITY_TRIMMED_CSV = 'Take 2/2variable-equalizer/live.csv'
FETAL_DEATH_TRIMMED_CSV = 'Take 2/2variable-equalizer/still.csv'
